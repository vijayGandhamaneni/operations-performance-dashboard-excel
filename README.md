...
## Approach
1. Imported and profiled raw operational data.
2. Validated data quality and confirmed no major cleaning issues.
3. Created business logic to classify orders as SLA Met or SLA Breached.
4. Calculated delivery delays to assess severity.
5. Built pivot tables to analyze order volume and SLA performance city-wise.
6. Created a simple dashboard with a visual chart and business insights.
